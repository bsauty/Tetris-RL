'''This is the working RL agent for reduced environment
...
class clever_agent():
    ...
    def __init__(self):
        ...
        # Parameters
        self.epsilon = 0.45  # probability of doing a random move
        self.epsilon_decay = 0.00001
        self.epsilon_end = 0.05

        self.gamma = 0.9     # discounted future rewarddq
        self.alpha = 0.01

        self.weights = [-1, -1, -1, -30]     # initial weight vector
    ...
    def try_move(self, action):
        ...
        from environment_reduced import grid, current_piece, valid_space, locked_positions,\
        ...
        one_step_reward = 5 * (test_inc * test_inc) - (height_sum - reference_height)
